...
export async function createNew(options: NewOptions): Promise<void> {
  ...
  console.log('\n📦 Creating new webmcp.land instance...\n');
  ...
  try {
    ...
    console.error('\n⚠ Failed to install dependencies. You can run "pnpm install" manually.');
  }
  ...
  console.log('\n✅ Done! Your webmcp.land instance is ready.\n');
