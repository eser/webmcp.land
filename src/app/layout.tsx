...
export const metadata: Metadata = {
  ...
  title: {
    default: "webmcp.land - MCP resources Community",
    template: "%s | webmcp.land",
  },
  description:
    "Discover, collect, and share the best MCP resources for ChatGPT, Claude, Gemini, and more. Join the largest community of AI prompt engineers and creators.",
  keywords: [
    "MCP resources",
    "MCP services",
    "WebMCP",
  ...
  authors: [{ name: "webmcp.land community" }],
  creator: "webmcp.land",
  publisher: "webmcp.land",
  icons: {
    icon: [
  ...
  other: {
    "apple-mobile-web-app-title": "webmcp.land",
  },
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: "webmcp.land",
    title: "webmcp.land - MCP resources Community",
    description:
      "Discover, collect, and share the best MCP resources for ChatGPT, Claude, Gemini, and more. Join the largest community of AI prompt engineers.",
    images: [
      {
        url: "/og.png",
        width: 1200,
        height: 630,
        alt: "webmcp.land - MCP resources Community",
      },
    ],
  },
  twitter: {
    ...
    title: "webmcp.land - MCP resources Community",
    description:
      "Discover, collect, and share the best MCP resources for ChatGPT, Claude, Gemini, and more.",
    images: ["/og.png"],
    creator: "@webmcp_land",
  },
  robots: {
  ...
  alternates: {
    canonical: process.env.BETTER_AUTH_URL || "https://webmcp.land",
  },
};
  ...
  return (
    <html lang={locale} dir={isRtl ? "rtl" : "ltr"} suppressHydrationWarning className={themeClasses} style={themeStyles}>
      ...
      <body className={`${fontClasses} antialiased`}>
        ...
        <Providers locale={locale} theme={config.theme} branding={{ ...config.branding, useCloneBranding: config.homepage?.useCloneBranding }}>
          {isEmbedRoute ? (
            children
          ) : (
            <>
