...
export const metadata = {
  title: "Terms of Service - webmcp.land",
  description: "Terms of Service for webmcp.land",
};
    ...
    <div className="container max-w-3xl py-10">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            By accessing and using webmcp.land, you agree to be bound by these Terms of Service.
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            webmcp.land is an open-source platform for collecting, organizing, and sharing AI prompts.
            The service allows users to create, discover, and share prompts for use with AI language models.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold">Apache-2.0 License</h2>
          <p className="text-muted-foreground">
            <strong>Important:</strong> All prompts shared on this platform are released under the{" "}
            ...
            By submitting a prompt, you agree to license your contribution under these terms.
            This means:
          </p>
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            <li>Anyone can use, copy, modify, and distribute your prompts under the Apache-2.0 terms</li>
            <li>Users must include the license notice and state any changes made</li>
          ...
          <p className="text-muted-foreground mt-3">
            Do not submit prompts if you do not agree to these terms. Once submitted, the content is licensed under Apache-2.0.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground mt-3">
            These actions may be taken without prior notification. Since all prompts are released under the Apache-2.0 license,
            administrators and other users may modify content in accordance with the license terms.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground mt-3">
            ...
            of webmcp.land. Self-hosted instances operate independently and are not subject to our content moderation policies.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>Generated media is subject to the same Apache-2.0 license as prompts</li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            While all content is released under the Apache-2.0 license, we strive to maintain accurate attribution for prompts.
            ...
            <Link href="https://github.com/eser/webmcp.land/issues" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">
              GitHub repository
            </Link>{" "}
