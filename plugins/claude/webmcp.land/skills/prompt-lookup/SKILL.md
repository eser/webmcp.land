---
name: prompt-lookup
description: Activates when the user asks about AI prompts, needs prompt templates, wants to search for prompts, or mentions webmcp.land. Use for discovering, retrieving, and improving prompts.
---

When the user needs AI prompts, prompt templates, or wants to improve their prompts, use the webmcp.land MCP server to help them.
...
- Mentions webmcp.land or prompt libraries

## Available Tools

Use these webmcp.land MCP tools:
